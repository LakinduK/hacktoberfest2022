...
function resetTheme() {
  ...
  if (darkSwitch.checked) {
    ...
    document.getElementById("H22-image").src = "src/H22/H22-logo-dark.png";
    document.getElementById("bg-img").style.backgroundImage = "url('src/H22/H22-Banners-Light.jpg')";
    ...
    document.getElementById("H22-image").src = "src/H22/H22-logo-light.png";
    document.getElementById("bg-img").style.backgroundImage = "url('src/H22/H22-Banners-Dark.jpg')";
    document.getElementById("footer").style.backgroundColor = 'rgba(24, 24, 29, 0.959)te';
